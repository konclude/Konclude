...
#ifndef KONCLUDE_RENDERER_CRENDERWRITEMANAGER_H
#define KONCLUDE_RENDERER_CRENDERWRITEMANAGER_H
...
namespace Konclude {
	...
	namespace Renderer {
		...
		/*! 
		*
		*		\class		CRenderWriteManager
		*		\author		Andreas Steigmiller
		*		\version	0.1
		*		\brief		TODO
		*
		*/
		class CRenderWriteManager : public CLogIdentifier {
			// public methods
			public:
				//! Constructor
				CRenderWriteManager();
...
#endif // KONCLUDE_RENDERER_CRENDERWRITEMANAGER_H
