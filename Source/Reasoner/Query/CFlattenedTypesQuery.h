	...
	namespace Reasoner {
		...
		namespace Query {
			...
			class CFlattenedTypesQuery : public CRealizationPremisingQuery {
				...
				public:
					//! Constructor
					CFlattenedTypesQuery(CConcreteOntology* ontology, CConfigurationBase* configuration, const CIndividualReference&, bool direct, const QString& individualName, const QString& flatternedTypeQueryName = QString("UnnamedFlattenedTypesQuery"));
