		...
		namespace Query {
			...
			class CSatisfiableCalculationJobsQuery : public CJobProvidedQuery {
				...
				public:
					...
					CSatisfiableCalculationJobsQuery* setCalculationConfiguration(CCalculationConfigurationExtension* calculationConfiguration);
				...
				protected:
					...
					CCalculationConfigurationExtension* mConfig;
