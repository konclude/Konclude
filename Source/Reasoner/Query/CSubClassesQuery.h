...
#ifndef KONCLUDE_REASONER_QUERY_CSUBCLASSESQUERY_H
#define KONCLUDE_REASONER_QUERY_CSUBCLASSESQUERY_H
...
namespace Konclude {
	...
	namespace Reasoner {
		...
		namespace Query {
			...
			/*! 
			 *
			 *		\class		CSubClassesQuery
			 *		\author		Andreas Steigmiller
			 *		\version	0.1
			 *		\brief		TODO
			 *
			 */
			class CSubClassesQuery : public CTaxonomyPremisingQuery {
				// public methods
				public:
					//! Constructor
					CSubClassesQuery(CConcreteOntology* ontology, CConfigurationBase* configuration, CConcept* concept, bool direct, const QString& className, const QString& queryName = QString("UnnamedQuery"));

					//! Destructor
					virtual ~CSubClassesQuery();
...
#endif // KONCLUDE_REASONER_QUERY_CSUBCLASSESQUERY_H
