...
#ifndef KONCLUDE_REASONER_QUERY_CFLATTENEDOBJECTPROPERTYSOURCESQUERY_H
#define KONCLUDE_REASONER_QUERY_CFLATTENEDOBJECTPROPERTYSOURCESQUERY_H
...
namespace Konclude {
	...
	namespace Reasoner {
		...
		namespace Query {
			...
			/*! 
			 *
			 *		\class		CFlattenedObjectPropertySourcesQuery
			 *		\author		Andreas Steigmiller
			 *		\version	0.1
			 *		\brief		TODO
			 *
			 */
			class CFlattenedObjectPropertySourcesQuery : public CRealizationPremisingQuery {
				// public methods
				public:
					//! Constructor
					CFlattenedObjectPropertySourcesQuery(CConcreteOntology* ontology, CConfigurationBase* configuration, const CIndividualReference& individualReference, const QString& individualName, CRole* role, const QString& objectPropertyTargetQueryName = QString("UnnamedObjectPropertyTargetsQuery"));

					//! Destructor
					virtual ~CFlattenedObjectPropertySourcesQuery();
...
#endif // KONCLUDE_REASONER_QUERY_CFLATTENEDOBJECTPROPERTYSOURCESQUERY_H
