...
#ifndef KONCLUDE_REASONER_QUERY_CWRITEQUERYFILEOWL2XMLSERIALIZER_H
#define KONCLUDE_REASONER_QUERY_CWRITEQUERYFILEOWL2XMLSERIALIZER_H
...
namespace Konclude {
	...
	namespace Reasoner {
		...
		namespace Query {
			...
			/*! 
			 *
			 *		\class		CWriteQueryFileOWL2XMLSerializer
			 *		\author		Andreas Steigmiller
			 *		\version	0.1
			 *		\brief		TODO
			 *
			 */
			class CWriteQueryFileOWL2XMLSerializer : public CWriteQueryFileSerializer {
				// public methods
				public:
					//! Constructor
					CWriteQueryFileOWL2XMLSerializer(const QString& fileString);
...
#endif // KONCLUDE_REASONER_QUERY_CWRITEQUERYFILEOWL2XMLSERIALIZER_H
