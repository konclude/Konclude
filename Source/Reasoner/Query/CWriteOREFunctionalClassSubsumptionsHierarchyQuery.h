...
#ifndef KONCLUDE_REASONER_QUERY_CWRITEOREFUNCTIONALCLASSSUBSUMPTIONSHIERARCHYQUERY_H
#define KONCLUDE_REASONER_QUERY_CWRITEOREFUNCTIONALCLASSSUBSUMPTIONSHIERARCHYQUERY_H
...
namespace Konclude {
	...
	namespace Reasoner {
		...
		namespace Query {
			...
			/*! 
			 *
			 *		\class		CWriteOREFunctionalClassSubsumptionsHierarchyQuery
			 *		\author		Andreas Steigmiller
			 *		\version	0.1
			 *		\brief		TODO
			 *
			 */
			class CWriteOREFunctionalClassSubsumptionsHierarchyQuery : public CTaxonomyPremisingQuery {
				// public methods
				public:
					//! Constructor
					CWriteOREFunctionalClassSubsumptionsHierarchyQuery(CConcreteOntology *premisingTaxonomyOntology, CConfigurationBase *configuration, const QString& outputFileString, const QString &superClassName = QString(""), const QString &subClassHierarchyQueryName = QString("UnnamedWriteClassHierarchyQuery"));
...
#endif // KONCLUDE_REASONER_QUERY_CWRITEOREFUNCTIONALCLASSSUBSUMPTIONSHIERARCHYQUERY_H
