...
namespace Konclude {
	...
	namespace Reasoner {
		...
		namespace Classifier {
			 ...
			 *
			 */
			class COptimizedKPSetRolePossibleSubsumptionMap : public QMap<CConceptTagComparer,COptimizedKPSetRolePossibleSubsumptionData*>, public CClassPossibleSubsumptionMap {
				// public methods
				public:
					//! Constructor
