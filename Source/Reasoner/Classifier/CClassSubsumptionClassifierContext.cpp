...
namespace Konclude {
	...
	namespace Reasoner {
		...
		namespace Classifier {
			...
			CMemoryPoolAllocationManager* CClassSubsumptionClassifierContext::getMemoryPoolAllocationManager() {
				return mMemMan;
			}


			CMemoryAllocationManager* CClassSubsumptionClassifierContext::getMemoryAllocationManager() {
				return mMemMan;
			}

			CMemoryPoolProvider* CClassSubsumptionClassifierContext::getMemoryPoolProvider() {
