...
namespace Konclude {
	...
	namespace Reasoner {
		...
		namespace Classifier {
			...
			CClassifiedCallbackDataContext::CClassifiedCallbackDataContext(CTaxonomy *taxanomy, CConcreteOntology *ontology) {
				tax = taxanomy;
				onto = ontology;
			}
			...
			CTaxonomy *CClassifiedCallbackDataContext::getTaxonomy() {
				return tax;
			}
