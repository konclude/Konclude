...
namespace Konclude {
	...
	namespace Reasoner {
		...
		namespace Classifier {
			...
			COptimizedKPSetRoleTestingItem* COptimizedKPSetRoleTestingItem::initSatisfiableTestingItem(CConcept* satTestConcept) {
			...
			CConcept* COptimizedKPSetRoleTestingItem::getTestingConcept() {
				return mConceptSat;
			}

			CHierarchyNode* COptimizedKPSetRoleTestingItem::getSatisfiableConceptHierarchyNode() {
				return mConSatHierNode;
			}


			COptimizedKPSetRoleTestingItem* COptimizedKPSetRoleTestingItem::setSatisfiableConceptHierarchyNode(CHierarchyNode* hierNode) {
				mConSatHierNode = hierNode;
				return this;
			}


			QSet<COptimizedKPSetRoleTestingItem*>* COptimizedKPSetRoleTestingItem::getSubsumingConceptItemSet() {
				return &mSubsumingConceptItemSet;
			}

			QList<COptimizedKPSetRoleTestingItem*>* COptimizedKPSetRoleTestingItem::getSubsumingConceptItemList() {
				return &mSubsumingConceptItemList;
			}


			cint64 COptimizedKPSetRoleTestingItem::getSubsumingConceptItemCount() const {
				return mSubsumingConceptItemSet.count();
			}

			bool COptimizedKPSetRoleTestingItem::hasSubsumerConceptItem(COptimizedKPSetRoleTestingItem* item) {
			...
			COptimizedKPSetRoleTestingItem* COptimizedKPSetRoleTestingItem::addSubsumingConceptItem(COptimizedKPSetRoleTestingItem* subsumingItem) {
			...
			CClassPossibleSubsumptionMap* COptimizedKPSetRoleTestingItem::getClassPossibleSubsumptionMap() {
			...
			QSet<COptimizedKPSetRoleTestingItem*>* COptimizedKPSetRoleTestingItem::getPossibleSubsumedSet(bool create) {
			...
			QList<COptimizedKPSetRoleTestingItem*>* COptimizedKPSetRoleTestingItem::getPossibleSubsumedList() {
