...
#ifndef KONCLUDE_REASONER_PREPROCESS_CONTOLOGYQUERYEXTENDEDCONFIGDEPENDEDPREPROCESSER_H
#define KONCLUDE_REASONER_PREPROCESS_CONTOLOGYQUERYEXTENDEDCONFIGDEPENDEDPREPROCESSER_H
...
namespace Konclude {
	...
	namespace Reasoner {
		...
		namespace Preprocess {
			...
			/*! 
			 *
			 *		\class		COntologyQueryExtendedConfigDependedPreProcesser
			 *		\author		Andreas Steigmiller
			 *		\version	0.1
			 *		\brief		TODO
			 *
			 */
			class COntologyQueryExtendedConfigDependedPreProcesser : public COntologyPreProcesser, public CLogIdentifier {
				// public methods
				public:
					//! Constructor
					COntologyQueryExtendedConfigDependedPreProcesser();

					//! Destructor
					virtual ~COntologyQueryExtendedConfigDependedPreProcesser();

					virtual CConcreteOntology *preprocess(CConcreteOntology *ontology, CConfiguration *config);

				// protected methods
				protected:
					virtual COntologyQueryExtendedConfigDependedPreProcesser* reportLog(const QString& string);

				// protected variables
				private:
					CNegationTransformationPreProcess* mNegNorm;
					CSubroleTransformationPreProcess* mSubRoleNorm;
					CDatatypeNormalizerPreProcess* mDatatypeNorm;
					CDataLiteralNormalizerPreProcess* mDataLitNorm;
					CTriggeredImplicationBinaryAbsorberPreProcess* mTriggImplNorm;
					CRoleChainAutomataTransformationPreProcess* mRoleChainAutomataTran;
					CLexicalNormalisationPreProcess* mLegNorm;
					CBranchTriggerPreProcess* mBraTrigTran;
					CCommonDisjunctConceptExtractionPreProcess* mCommDisConExt;
					CDisjunctSortingPreProcess* mSortDisjPre;
					CDataExtenderPreProcess* mDataExtender;
					CBranchStatisticsExtenderPreProcess* mBranchStatExtener;
...
#endif // KONCLUDE_REASONER_PREPROCESS_CONTOLOGYQUERYEXTENDEDCONFIGDEPENDEDPREPROCESSER_H
