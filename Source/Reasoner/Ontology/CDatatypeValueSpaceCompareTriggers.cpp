...
namespace Konclude {
	...
	namespace Reasoner {
		...
		namespace Ontology {
			...
			CDatatypeValueSpaceCompareTriggers::CDatatypeValueSpaceCompareTriggers(CBoxContext* boxContext) : CDatatypeValueSpaceTriggers(boxContext),mValueTriggerMap(boxContext) {
			}
