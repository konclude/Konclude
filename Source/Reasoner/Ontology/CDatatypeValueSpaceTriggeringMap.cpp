...
namespace Konclude {
	...
	namespace Reasoner {
		...
		namespace Ontology {
			...
			CDatatypeValueSpaceTriggeringMap::CDatatypeValueSpaceTriggeringMap(CContext* boxContext) : CBOXMAP<CDatatypeValueSpaceTriggeringMapArranger,CDatatypeValueSpaceTriggeringMapData>(boxContext),mBoxContext(boxContext) {
			}
