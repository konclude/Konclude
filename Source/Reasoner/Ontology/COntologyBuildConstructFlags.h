		...
		namespace Ontology {
			...
			class COntologyBuildConstructFlags {
				...
				public:
					...
					bool isBottomRoleUsed();
					COntologyBuildConstructFlags* setBottomRoleUsed(bool used = true);

					bool isTopRoleUsed();
					COntologyBuildConstructFlags* setTopRoleUsed(bool used = true);
