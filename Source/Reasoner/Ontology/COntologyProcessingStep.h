		...
		namespace Ontology {
			...
			class COntologyProcessingStep {
				...
				public:
					...
					enum PROCESSINGSTEPTYPE { OPSACTIVECOUNT = 0, OPSBUILD = 1, OPSPREPROCESS = 2, OPSCONSISTENCY = 3, OPSPRECOMPUTESATURATION = 4, OPSPRECOMPUTECYCLES = 5, OPSCLASSCLASSIFY = 6, OPSCONCEPTREALIZE = 7, OPSSAMEINDIVIDUALSREALIZE = 8 };
					enum PROCESSORTYPE { OPPREPROCESSOR, OPPRECOMPUTER, OPCLASSCLASSIFIER, OPCONCEPTREALIZER };
