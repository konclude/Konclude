...
namespace Konclude {
	...
	namespace Reasoner {
		...
		namespace Ontology {
			...
			CDatatypeValueSpaceBinaryBase64DataTriggers::CDatatypeValueSpaceBinaryBase64DataTriggers(CBoxContext* boxContext) : CDatatypeValueSpaceCompareTriggers(boxContext) {
			}
