...
#ifndef KONCLUDE_REASONER_REALIZER_COPTIMIZEDREPRESENTATIVEKPSETCACHEMULTIPLETYPELABELSETITEMITERATOR_H
#define KONCLUDE_REASONER_REALIZER_COPTIMIZEDREPRESENTATIVEKPSETCACHEMULTIPLETYPELABELSETITEMITERATOR_H
...
namespace Konclude {
	...
	namespace Reasoner {
		...
		namespace Realizer {
			...
			/*! 
			 *
			 *		\class		COptimizedRepresentativeKPSetCacheMultipleTypeLabelSetItemIterator
			 *		\author		Andreas Steigmiller
			 *		\version	0.1
			 *		\brief		TODO
			 *
			 */
			class COptimizedRepresentativeKPSetCacheMultipleTypeLabelSetItemIterator : public COptimizedRepresentativeKPSetCacheLabelItemIterator {
				// public methods
				public:
					//! Constructor
...
#endif // KONCLUDE_REASONER_REALIZER_COPTIMIZEDREPRESENTATIVEKPSETCACHEMULTIPLETYPELABELSETITEMITERATOR_H
