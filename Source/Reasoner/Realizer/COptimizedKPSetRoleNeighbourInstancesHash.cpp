...
namespace Konclude {
	...
	namespace Reasoner {
		...
		namespace Realizer {
			...
			COptimizedKPSetRoleInstancesData* COptimizedKPSetRoleNeighbourInstancesHash::getRoleSuccessorInstanceItemData(COptimizedKPSetRoleInstancesItem* item, COptimizedKPSetIndividualItem* successorItem) {
			...
			COptimizedKPSetRoleInstancesData* COptimizedKPSetRoleNeighbourInstancesHash::getRolePredecessorInstanceItemData(COptimizedKPSetRoleInstancesItem* item, COptimizedKPSetIndividualItem* predecessorItem) {
				COptimizedKPSetRoleNeighbourInstancesHashData& hashData = QHash<COptimizedKPSetRoleInstancesItem*,COptimizedKPSetRoleNeighbourInstancesHashData>::operator[](item);
