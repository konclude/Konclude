...
#ifndef KONCLUDE_REASONER_REALIZER_CREALIZINGCONTEXT_H
#define KONCLUDE_REASONER_REALIZER_CREALIZINGCONTEXT_H
...
namespace Konclude {
	...
	namespace Reasoner {
		...
		namespace Realizer {
			...
			/*! 
			 *
			 *		\class		CRealizingContext
			 *		\author		Andreas Steigmiller
			 *		\version	0.1
			 *		\brief		TODO
			 *
			 */
			class CRealizingContext : public CContext {
				// public methods
				public:
					//! Constructor
					CRealizingContext();

					virtual ~CRealizingContext();
...
#endif // KONCLUDE_REASONER_REALIZER_CREALIZINGCONTEXT_H
