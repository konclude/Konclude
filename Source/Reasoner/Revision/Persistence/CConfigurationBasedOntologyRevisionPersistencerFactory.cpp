...
#include "CConfigurationBasedOntologyRevisionPersistencerFactory.h"
	...
	namespace Reasoner {
		...
		namespace Revision {
			...
			namespace Persistence {
				...
				CConfigurationBasedOntologyRevisionPersistencerFactory::CConfigurationBasedOntologyRevisionPersistencerFactory(CConfiguration* config) {
					mConfig = config;
				}
