...
#ifndef KONCLUDE_REASONER_TAXONOMY_CCONCEPTPCPRHIERARCHYNODE_H
#define KONCLUDE_REASONER_TAXONOMY_CCONCEPTPCPRHIERARCHYNODE_H
...
namespace Konclude {
	...
	namespace Reasoner {
		...
		namespace Taxonomy {
			...
			/*! 
			 *
			 *		\class		CConceptPCPrHierarchyNode
			 *		\author		Andreas Steigmiller
			 *		\version	0.1
			 *		\brief		TODO
			 *
			 */
			class CConceptPCPrHierarchyNode : public CPCPrHierarchyNode<CConceptPCPrHierarchyNode, CConcept *> {
				// public methods
				public:
					//! Constructor
					CConceptPCPrHierarchyNode(CConcept *representiveConcept);

					//! Deconstructor
					virtual ~CConceptPCPrHierarchyNode();

					virtual CConceptPCPrHierarchyNode *addEquivalentConcept(CConcept *concept);
				...
				protected:
					...
					virtual CConceptPCPrHierarchyNode *generateNodeStrings();
#endif
...
#endif // KONCLUDE_REASONER_TAXONOMY_CCONCEPTPCPRHIERARCHYNODE_H
