		...
		namespace Realization {
			...
			class CRoleRealization {
				...
				public:
					...
					virtual bool visitTargetIndividuals(CRoleInstanceItem* individualItem, CRoleInstantiatedItem* roleItem, CRoleRealizationInstanceVisitor* visitor) = 0;

					virtual bool visitIndividuals(CRoleInstanceItem* item, CRoleRealizationIndividualVisitor* visitor) = 0;
