...
#ifndef KONCLUDE_REASONER_REALIZATION_REALIZATIONSETTINGS
#define KONCLUDE_REASONER_REALIZATION_REALIZATIONSETTINGS
...
namespace Konclude {
	...
	namespace Reasoner {
		...
		namespace Realization {
			...
			struct IndividualIdCandidateData {
			};
...
#endif // end KONCLUDE_REASONER_REALIZATION_REALIZATIONSETTINGS