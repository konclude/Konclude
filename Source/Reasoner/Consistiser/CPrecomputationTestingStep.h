			...
			class CPrecomputationTestingStep {
				...
				public:
					enum TESTINGSTEPTYPE {
						CONSISTENCYPRECOMPUTATIONSTEP, CYCLEPRECOMPUTATIONSTEP, SATURATIONPRECOMPUTATIONSTEP, INDIVIDUALPRECOMPUTATIONSTEP, OCCURRENCESTATISTICSPRECOMPUTATIONSTEP
					};
