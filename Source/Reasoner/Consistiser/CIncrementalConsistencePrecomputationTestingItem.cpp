...
namespace Konclude {
	...
	namespace Reasoner {
		...
		namespace Consistiser {
			...
			CPrecomputationTestingItem::PRECOMPUTATIONTYPE CIncrementalConsistencePrecomputationTestingItem::getPrecomputationTestingType() {
				return CONSISTENCEPRECOMPUTATIONTYPE;
			}

			CSatisfiableTaskIncrementalConsistencyTestingAdapter* CIncrementalConsistencePrecomputationTestingItem::getIncrementalConsistencyTestingAdapter() {
				return &mTaskIncConsTestAdapter;
			}
