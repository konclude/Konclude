			...
			class CAnsweringMessageDataCalculationCompleted : public CAnsweringMessageData, public CJobSatisfiableCallbackContextData {
				...
				public:
					...
					enum CALCULATIONTYPE {
						...
						VARIABLEBINDINGPPROPAGATIONCALCULATION, VARIABLEBINDINGCONFIRMATIONCALCULATION, VARIABLEBINDINGENTAILMENTCALCULATION, QUERYMATERIALIZATIONCALCULATION, CLASSSUBSUMPTIONCALCULATION
					};
