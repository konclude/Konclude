...
#ifndef KONCLUDE_REASONER_ANSWERER_CINSTANCESCOMPUTATIONREQUIREMENTDATA_H
#define KONCLUDE_REASONER_ANSWERER_CINSTANCESCOMPUTATIONREQUIREMENTDATA_H
...
namespace Konclude {
	...
	namespace Reasoner {
		...
		namespace Answerer {
			...
			/*! 
			 *
			 *		\class		CInstancesComputationRequirements
			 *		\author		Andreas Steigmiller
			 *		\version	0.1
			 *		\brief		TODO
			 *
			 */
			class CRequirementWaitingDependencyData {
				// public methods
				public:
					//! Constructor
...
#endif // KONCLUDE_REASONER_ANSWERER_CINSTANCESCOMPUTATIONREQUIREMENTDATA_H
