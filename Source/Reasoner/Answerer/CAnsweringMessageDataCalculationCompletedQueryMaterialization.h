...
#ifndef KONCLUDE_REASONER_ANSWERER_CANSWERINGMESSAGEDATACALCULATIONCOMPLETEDQUERYMATERIALIZATION_H
#define KONCLUDE_REASONER_ANSWERER_CANSWERINGMESSAGEDATACALCULATIONCOMPLETEDQUERYMATERIALIZATION_H
...
namespace Konclude {
	...
	namespace Reasoner {
		...
		namespace Answerer {
			...
			/*! 
			 *
			 *		\class		CAnsweringMessageDataCalculationCompletedQueryMaterialization
			 *		\author		Andreas Steigmiller
			 *		\version	0.1
			 *		\brief		TODO
			 *
			 */
			class CAnsweringMessageDataCalculationCompletedQueryMaterialization : public CAnsweringMessageDataCalculationCompleted {
				// public methods
				public:
					//! Constructor
...
#endif // KONCLUDE_REASONER_ANSWERER_CANSWERINGMESSAGEDATACALCULATIONCOMPLETEDQUERYMATERIALIZATION_H
