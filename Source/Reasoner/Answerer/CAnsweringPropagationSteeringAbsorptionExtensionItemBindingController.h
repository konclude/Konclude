...
#ifndef KONCLUDE_REASONER_ANSWERER_CAnsweringPropagationSteeringAbsorptionExtensionItemBindingController_H
#define KONCLUDE_REASONER_ANSWERER_CAnsweringPropagationSteeringAbsorptionExtensionItemBindingController_H
...
namespace Konclude {
	...
	namespace Reasoner {
		...
		namespace Answerer {
			...
			/*! 
			 *
			 *		\class		CAnsweringPropagationSteeringAbsorptionExtensionItemBindingController
			 *		\author		Andreas Steigmiller
			 *		\version	0.1
			 *		\brief		TODO
			 *
			 */
			class CAnsweringPropagationSteeringAbsorptionExtensionItemBindingController : public CAnsweringPropagationSteeringController {
				// public methods
				public:
					//! Constructor
					CAnsweringPropagationSteeringAbsorptionExtensionItemBindingController(COptimizedComplexVariableAbsorptionBasedHandlingExtensionItem* absorptionPropagationItem, const COptimizedComplexVariableIndividualBindings& binding, CSameRealization* sameRealization);

					//! Destructor
					virtual ~CAnsweringPropagationSteeringAbsorptionExtensionItemBindingController();
...
#endif // KONCLUDE_REASONER_ANSWERER_CAnsweringPropagationSteeringAbsorptionExtensionItemBindingController_H
