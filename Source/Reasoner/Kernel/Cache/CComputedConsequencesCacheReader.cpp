	...
	namespace Reasoner {
		...
		namespace Kernel {
			...
			namespace Cache {
				...
				CComputedConsequencesCacheReader::CComputedConsequencesCacheReader() : CLinkerBase<CComputedConsequencesCacheReader*,CComputedConsequencesCacheReader>(this) {
				}


				CComputedConsequencesTypesCacheEntry* CComputedConsequencesCacheReader::getTypesCacheEntry(CIndividual* individual) {
