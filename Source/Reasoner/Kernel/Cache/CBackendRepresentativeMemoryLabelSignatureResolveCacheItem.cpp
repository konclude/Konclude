	...
	namespace Reasoner {
		...
		namespace Kernel {
			...
			namespace Cache {
				...
				CBackendRepresentativeMemoryLabelSignatureResolveCacheItem::CBackendRepresentativeMemoryLabelSignatureResolveCacheItem(CBackendRepresentativeMemoryCacheContext* context) : mContext(context) {
					mSignature = 0;
					mLabelItemCount = 0;
				...
				cint64 CBackendRepresentativeMemoryLabelSignatureResolveCacheItem::getSignature() {
					return mSignature;
				}

				CBackendRepresentativeMemoryLabelSignatureResolveCacheItem* CBackendRepresentativeMemoryLabelSignatureResolveCacheItem::setSignature(cint64 signature) {
