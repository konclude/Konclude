	...
	namespace Reasoner {
		...
		namespace Kernel {
			...
			namespace Cache {
				...
				CSaturationNodeAssociatedNondeterministicConceptExpansion::CSaturationNodeAssociatedNondeterministicConceptExpansion(CSaturationNodeAssociatedExpansionCacheContext* context) : CSaturationNodeAssociatedConceptExpansion(context),CLinkerBase<CSaturationNodeAssociatedNondeterministicConceptExpansion*,CSaturationNodeAssociatedNondeterministicConceptExpansion>(this,nullptr) {
				}


				CSaturationNodeAssociatedNondeterministicConceptExpansion* CSaturationNodeAssociatedNondeterministicConceptExpansion::initNondeterministicConceptExpansion() {
