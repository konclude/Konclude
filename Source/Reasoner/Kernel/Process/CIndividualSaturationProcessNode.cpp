		...
		namespace Kernel {
			...
			namespace Process {
				...
				CIndividualSaturationProcessNode* CIndividualSaturationProcessNode::initCopingIndividualSaturationProcessNode(CIndividualSaturationProcessNode* indiNode) {
					...
					CXLinker<CIndividualSaturationProcessNode*>* depCopyLinker = CObjectAllocator< CXLinker<CIndividualSaturationProcessNode*> >::allocateAndConstruct(mMemAllocMan);
				...
				CXLinker<CIndividualSaturationProcessNode*>* CIndividualSaturationProcessNode::getCopyDependingIndividualNodeLinker() {
					return mDependingIndiNodeLinker;
				}

				CIndividualSaturationProcessNode* CIndividualSaturationProcessNode::setCopyDependingIndividualNodeLinker(CXLinker<CIndividualSaturationProcessNode*>* indiLinker) {
					mDependingIndiNodeLinker = indiLinker;
					return this;
				}

				CIndividualSaturationProcessNode* CIndividualSaturationProcessNode::addCopyDependingIndividualNodeLinker(CXLinker<CIndividualSaturationProcessNode*>* indiLinker) {
					if (indiLinker) {
