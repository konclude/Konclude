	...
	namespace Reasoner {
		...
		namespace Kernel {
			...
			namespace Process {
				...
				CBlockingFollowSet::CBlockingFollowSet(CProcessContext* context) : CPROCESSSET<cint64>(context),CBlockingFollowUpdateTag(0) {
					mContext = context;
				}
				...
				CBlockingFollowSet* CBlockingFollowSet::initBlockingFollowSet(CBlockingFollowSet* sigBlockFollowSet) {
					if (sigBlockFollowSet) {
						*this = *sigBlockFollowSet;
						...
						initBlockingFollowTag(mContext->getProcessTagger()->getCurrentBlockingFollowTag());
					}
					return this;
				}
