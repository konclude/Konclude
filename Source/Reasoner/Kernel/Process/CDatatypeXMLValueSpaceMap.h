...
#ifndef KONCLUDE_REASONER_KERNEL_PROCESS_CDATATYPEXMLVALUESPACEMAP_H
...
// Other includes
#include "Reasoner/Ontology/CDataLiteralXMLValue.h"
	...
	namespace Reasoner {
		...
		namespace Kernel {
			...
			namespace Process {
				...
				/*! 
				 *
				 *		\class		CDatatypeXMLValueSpaceMap
				 *		\author		Andreas Steigmiller
				 *		\version	0.1
				 *		\brief		TODO
				 *
				 */
				class CDatatypeXMLValueSpaceMap : public CDatatypeCompareValueSpaceMap {
					// public methods
					public:
						//! Constructor
						CDatatypeXMLValueSpaceMap(CProcessContext* processContext);
...
#endif // KONCLUDE_REASONER_KERNEL_PROCESS_CDATATYPEXMLVALUESPACEMAP_H
