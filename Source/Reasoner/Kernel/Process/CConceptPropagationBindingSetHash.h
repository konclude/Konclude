			...
			namespace Process {
				...
				class CConceptPropagationBindingSetHash : public CPROCESSHASH<cint64,CConceptPropagationBindingSetHashData> {
					...
					public:
						...
						CPropagationBindingDescriptor* getLastPropagationBindingDescriptor();
						CConceptPropagationBindingSetHash* setLastPropagationBindingDescriptor(CPropagationBindingDescriptor* propBindDes);
