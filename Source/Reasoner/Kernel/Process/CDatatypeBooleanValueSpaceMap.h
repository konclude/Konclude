...
#ifndef KONCLUDE_REASONER_KERNEL_PROCESS_CDATATYPEBOOLEANVALUESPACEMAP_H
#define KONCLUDE_REASONER_KERNEL_PROCESS_CDATATYPEBOOLEANVALUESPACEMAP_H
...
// Other includes
#include "Reasoner/Ontology/CDataLiteralBooleanValue.h"
	...
	namespace Reasoner {
		...
		namespace Kernel {
			...
			namespace Process {
				...
				/*! 
				 *
				 *		\class		CDatatypeBooleanValueSpaceMap
				 *		\author		Andreas Steigmiller
				 *		\version	0.1
				 *		\brief		TODO
				 *
				 */
				class CDatatypeBooleanValueSpaceMap : public CDatatypeCompareValueSpaceMap {
					// public methods
					public:
						//! Constructor
						CDatatypeBooleanValueSpaceMap(CProcessContext* processContext);
...
#endif // KONCLUDE_REASONER_KERNEL_PROCESS_CDATATYPEBOOLEANVALUESPACEMAP_H
