	...
	namespace Reasoner {
		...
		namespace Kernel {
			...
			namespace Process {
				...
				CVariableBindingPathJoiningHasher::CVariableBindingPathJoiningHasher(CVariableBindingPathJoiningData* data) {
				...
				CVariableBindingPathJoiningHasher::CVariableBindingPathJoiningHasher(CVariableBindingPath* varBindPath, CSortedLinker<CVariable*>* keyVars) {
				...
				cint64 CVariableBindingPathJoiningHasher::calculateHashValue(CVariableBindingPath* varBindPath, CSortedLinker<CVariable*>* keyVars) {
					cint64 hashValue = 0;
				...
				cint64 CVariableBindingPathJoiningHasher::getHashValue() const {
					return mHashValue;
				}

				bool CVariableBindingPathJoiningHasher::operator==(const CVariableBindingPathJoiningHasher& hasher) const {
