	...
	namespace Reasoner {
		...
		namespace Kernel {
			...
			namespace Process {
				...
				CAdditionalProcessRoleAssertionsLinker* CAdditionalProcessRoleAssertionsLinker::initAdditionalProcessRoleAssertionsLinker(CIndividual* individual, CRoleAssertionLinker* roleAssertionLinker, CReverseRoleAssertionLinker* reverseRoleAssertionLinker) {
					setData(individual);
