	...
	namespace Reasoner {
		...
		namespace Kernel {
			...
			namespace Process {
				...
				CIndividualRepresentativeBackendCacheConceptSetLabelProcessingHash* CIndividualRepresentativeBackendCacheConceptSetLabelProcessingHash::initIndividualRepresentativeBackendCacheConceptSetLabelProcessingHash(CIndividualRepresentativeBackendCacheConceptSetLabelProcessingHash* prevHash) {
					if (prevHash) {
						*this = *prevHash;
					} else {
