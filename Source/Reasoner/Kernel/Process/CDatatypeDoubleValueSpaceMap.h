...
#ifndef KONCLUDE_REASONER_KERNEL_PROCESS_CDATATYPEDOUBLEVALUESPACEMAP_H
...
// Other includes
#include "Reasoner/Ontology/CDataLiteralDoubleValue.h"
	...
	namespace Reasoner {
		...
		namespace Kernel {
			...
			namespace Process {
				...
				/*! 
				 *
				 *		\class		CDatatypeDoubleValueSpaceMap
				 *		\author		Andreas Steigmiller
				 *		\version	0.1
				 *		\brief		TODO
				 *
				 */
				class CDatatypeDoubleValueSpaceMap : public CDatatypeCompareValueSpaceMap {
					// public methods
					public:
						//! Constructor
						CDatatypeDoubleValueSpaceMap(CProcessContext* processContext);
...
#endif // KONCLUDE_REASONER_KERNEL_PROCESS_CDATATYPEDOUBLEVALUESPACEMAP_H
