	...
	namespace Reasoner {
		...
		namespace Kernel {
			...
			namespace Process {
				...
				CVariableBindingPathMap::CVariableBindingPathMap(CProcessContext* processContext) : mProcessContext(processContext),CPROCESSMAP<cint64,CVariableBindingPathMapData>(processContext) {
				}
