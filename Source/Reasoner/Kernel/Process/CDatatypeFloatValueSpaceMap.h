...
#ifndef KONCLUDE_REASONER_KERNEL_PROCESS_CDATATYPEFLOATVALUESPACEMAP_H
#define KONCLUDE_REASONER_KERNEL_PROCESS_CDATATYPEFLOATVALUESPACEMAP_H
...
// Other includes
#include "Reasoner/Ontology/CDataLiteralFloatValue.h"
	...
	namespace Reasoner {
		...
		namespace Kernel {
			...
			namespace Process {
				...
				/*! 
				 *
				 *		\class		CDatatypeFloatValueSpaceMap
				 *		\author		Andreas Steigmiller
				 *		\version	0.1
				 *		\brief		TODO
				 *
				 */
				class CDatatypeFloatValueSpaceMap : public CDatatypeCompareValueSpaceMap {
					// public methods
					public:
						//! Constructor
						CDatatypeFloatValueSpaceMap(CProcessContext* processContext);
...
#endif // KONCLUDE_REASONER_KERNEL_PROCESS_CDATATYPEFLOATVALUESPACEMAP_H
