...
#ifndef KONCLUDE_REASONER_KERNEL_PROCESS_DEPENDENCY_CMERGEDLINKDEPENDENCYNODE_H
		...
		namespace Kernel {
			...
			namespace Process {
				...
				namespace Dependency {
					...
					/*! 
					 *
					 *		\class		CMERGEDLINKDependencyNode
					 *		\author		Andreas Steigmiller
					 *		\version	0.1
					 *		\brief		TODO
					 *
					 */
					class CMERGEDLINKDependencyNode : public CDeterministicDependencyNode {
						// public methods
						public:
							//! Constructor
							CMERGEDLINKDependencyNode(CProcessContext* processContext = nullptr);
...
#endif // KONCLUDE_REASONER_KERNEL_PROCESS_DEPENDENCY_CMERGEDLINKDEPENDENCYNODE_H
