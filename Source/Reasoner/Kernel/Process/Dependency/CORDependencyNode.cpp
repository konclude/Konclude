		...
		namespace Kernel {
			...
			namespace Process {
				...
				namespace Dependency {
					...
					CNonDeterministicDependencyTrackPoint* CORDependencyNode::getDependencyTrackPointBranch() {
						CORDisjunctDependencyTrackPoint* nonDetTrackPoint = CObjectParameterizingAllocator< CORDisjunctDependencyTrackPoint,CNonDeterministicDependencyNode* >::allocateAndConstructAndParameterize(mProcessContext->getUsedMemoryAllocationManager(),this);
