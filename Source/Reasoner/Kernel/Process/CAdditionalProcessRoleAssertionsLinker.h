	...
	namespace Reasoner {
		...
		namespace Kernel {
			...
			namespace Process {
				 ...
				 *
				 */
				class CAdditionalProcessRoleAssertionsLinker : public CLinkerBase<CIndividual*,CAdditionalProcessRoleAssertionsLinker> {
					// public methods
					public:
						//! Constructor
						CAdditionalProcessRoleAssertionsLinker();

						CAdditionalProcessRoleAssertionsLinker* initAdditionalProcessRoleAssertionsLinker(CIndividual* individual, CRoleAssertionLinker* roleAssertionLinker, CReverseRoleAssertionLinker* reverseRoleAssertionLinker);
