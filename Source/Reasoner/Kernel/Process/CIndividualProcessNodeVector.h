	...
	namespace Reasoner {
		...
		namespace Kernel {
			...
			namespace Process {
				 ...
				 *
				 */
				class CIndividualProcessNodeVector : public CDefaultDynamicReferenceVectorBase<CIndividualProcessNode*,CIndividualProcessNodeVector,CINDIVIDUALPROCESSNODEVECTOR2POTSIZE> {
					// public methods
					public:
						//! Constructor
