	...
	namespace Reasoner {
		...
		namespace Kernel {
			...
			namespace Process {
				...
				CIndividualDepthConceptProcessDescriptorProcessingQueue* CIndividualDepthConceptProcessDescriptorProcessingQueue::removeQueuedProcessIndiviudal(CIndividualProcessNode* individual) {
					CIndividualDepthPriority priority(individual->getIndividualNominalLevelOrAncestorDepth(),individual->getIndividualID());
					mPriorityIndiDesMap.remove(priority);
					return this;
				}
