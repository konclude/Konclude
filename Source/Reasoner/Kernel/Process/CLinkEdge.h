...
#ifndef KONCLUDE_REASONER_KERNEL_PROCESS_CLINKEDGE_H
	...
	namespace Reasoner {
		...
		namespace Kernel {
			...
			namespace Process {
				 ...
				 *
				 */
				class CLinkEdge : public CNodeEdge {
					// public methods
					public:
						//! Constructor
						CLinkEdge(CProcessContext* processContext = nullptr);
...
#endif // KONCLUDE_REASONER_KERNEL_PROCESS_CLINKEDGE_H
