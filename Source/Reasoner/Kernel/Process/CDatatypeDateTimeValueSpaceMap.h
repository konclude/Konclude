...
#ifndef KONCLUDE_REASONER_KERNEL_PROCESS_CDATATYPEDATETIMEVALUESPACEMAP_H
#define KONCLUDE_REASONER_KERNEL_PROCESS_CDATATYPEDATETIMEVALUESPACEMAP_H
	...
	namespace Reasoner {
		...
		namespace Kernel {
			...
			namespace Process {
				...
				/*! 
				 *
				 *		\class		CDatatypeDateTimeValueSpaceMap
				 *		\author		Andreas Steigmiller
				 *		\version	0.1
				 *		\brief		TODO
				 *
				 */
				class CDatatypeDateTimeValueSpaceMap : public CDatatypeCompareValueSpaceMap {
					// public methods
					public:
						//! Constructor
						CDatatypeDateTimeValueSpaceMap(CProcessContext* processContext);

						CDatatypeDateTimeValueSpaceMap* initDatatypeDateTimeValueSpaceMap(CDatatypeValueSpaceDateTimeType* valueSpaceType);
...
#endif // KONCLUDE_REASONER_KERNEL_PROCESS_CDATATYPEDATETIMEVALUESPACEMAP_H
