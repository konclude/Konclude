...
#ifndef KONCLUDE_REASONER_KERNEL_PROCESS_CREAPPLYROLESUCCESSORDATA_H
#define KONCLUDE_REASONER_KERNEL_PROCESS_CREAPPLYROLESUCCESSORDATA_H
	...
	namespace Reasoner {
		...
		namespace Kernel {
			...
			namespace Process {
				...
				/*! 
				 *
				 *		\class		CReapplyRoleSuccessorData
				...
				class CReapplyRoleSuccessorData {
					// public methods
					public:
						inline CReapplyRoleSuccessorData() {
							mLinkLinker = nullptr;
...
#endif // KONCLUDE_REASONER_KERNEL_PROCESS_CREAPPLYROLESUCCESSORDATA_H
