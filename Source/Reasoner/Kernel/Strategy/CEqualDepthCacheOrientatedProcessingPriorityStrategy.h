...
#ifndef KONCLUDE_REASONER_KERNEL_STRATEGY_CEQUALDEPTHCACHEORIENTATEDPROCESSINGPRIORITYSTRATEGY_H
	...
	namespace Reasoner {
		...
		namespace Kernel {
			...
			namespace Strategy {
				...
				/*! 
				 *
				 *		\class		CEqualDepthCacheOrientatedProcessingPriorityStrategy
				 *		\author		Andreas Steigmiller
				 *		\version	0.1
				 *		\brief		TODO
				 *
				 */
				class CEqualDepthCacheOrientatedProcessingPriorityStrategy : public CEqualDepthTaskProcessingPriorityStrategy {
					// public methods
					public:
						//! Constructor
						CEqualDepthCacheOrientatedProcessingPriorityStrategy();

						//! Destructor
						virtual ~CEqualDepthCacheOrientatedProcessingPriorityStrategy();
...
#endif // KONCLUDE_REASONER_KERNEL_STRATEGY_CEQUALDEPTHCACHEORIENTATEDPROCESSINGPRIORITYSTRATEGY_H
