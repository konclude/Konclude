			...
			namespace Strategy {
				...
				class CEqualDepthTaskProcessingPriorityStrategy : public CTaskProcessingPriorityStrategy {
					...
					public:
						...
						virtual double getPriorityForTaskBranching(CSatisfiableCalculationTask* branchingTask, CSatisfiableCalculationTask* parentTask, CConceptDescriptor* branchingConcept, CSortedNegLinker<CConcept*>* branchedConcept, cint64 branchNumber);
