...
#ifndef KONCLUDE_REASONER_KERNEL_ALGORITHM_CSATISFIABLETASKMARKERINDIVIDUALPROPAGATIONANALYSER_H
	...
	namespace Reasoner {
		...
		namespace Kernel {
			...
			namespace Algorithm {
				...
				/*! 
				 *
				 *		\class		CSatisfiableTaskMarkerIndividualPropagationAnalyser
...
#endif // KONCLUDE_REASONER_KERNEL_ALGORITHM_CSATISFIABLETASKMARKERINDIVIDUALPROPAGATIONANALYSER_H
