...
#ifndef KONCLUDE_REASONER_KERNEL_ALGORITHM_CSATISFIABLETASKSATURATIONSUBSUMPTIONIDENTIFIERANALYSER_H
#define KONCLUDE_REASONER_KERNEL_ALGORITHM_CSATISFIABLETASKSATURATIONSUBSUMPTIONIDENTIFIERANALYSER_H
	...
	namespace Reasoner {
		...
		namespace Kernel {
			...
			namespace Algorithm {
				...
				/*! 
				 *
				 *		\class		CSatisfiableTaskSaturationSubsumptionIdentifierAnalyser
				...
				class CSatisfiableTaskSaturationSubsumptionIdentifierAnalyser {
					...
					public:
						//! Constructor
						CSatisfiableTaskSaturationSubsumptionIdentifierAnalyser();
...
#endif // KONCLUDE_REASONER_KERNEL_ALGORITHM_CSATISFIABLETASKSATURATIONSUBSUMPTIONIDENTIFIERANALYSER_H
