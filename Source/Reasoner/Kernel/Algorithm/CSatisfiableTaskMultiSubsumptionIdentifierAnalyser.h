...
#ifndef KONCLUDE_REASONER_KERNEL_ALGORITHM_CSATISFIABLETASKMULTISUBSUMPTIONIDENTIFIERANALYSER_H
#define KONCLUDE_REASONER_KERNEL_ALGORITHM_CSATISFIABLETASKMULTISUBSUMPTIONIDENTIFIERANALYSER_H
	...
	namespace Reasoner {
		...
		namespace Kernel {
			...
			namespace Algorithm {
				...
				/*! 
				 *
				 *		\class		CSatisfiableTaskMultiSubsumptionIdentifierAnalyser
				...
				class CSatisfiableTaskMultiSubsumptionIdentifierAnalyser {
					...
					public:
						//! Constructor
						CSatisfiableTaskMultiSubsumptionIdentifierAnalyser();
...
#endif // KONCLUDE_REASONER_KERNEL_ALGORITHM_CSATISFIABLETASKMULTISUBSUMPTIONIDENTIFIERANALYSER_H
