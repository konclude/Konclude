...
#ifndef KONCLUDE_REASONER_KERNEL_ALGORITHM_CSATISFIABLETASKSATURATIONPREYINGANALYSER_H
	...
	namespace Reasoner {
		...
		namespace Kernel {
			...
			namespace Algorithm {
				...
				/*! 
				 *
				 *		\class		CSatisfiableTaskSaturationPreyingAnalyser
				 *		\author		Andreas Steigmiller
				 *		\version	0.1
				 *		\brief		TODO
				 *
				 */
				class CSatisfiableTaskSaturationPreyingAnalyser : public CSatisfiableConsistencyPreyingAnalyser {
					// public methods
					public:
						//! Constructor
						...
						//! Destructor
						virtual ~CSatisfiableTaskSaturationPreyingAnalyser();
...
#endif // KONCLUDE_REASONER_KERNEL_ALGORITHM_CSATISFIABLETASKSATURATIONPREYINGANALYSER_H
