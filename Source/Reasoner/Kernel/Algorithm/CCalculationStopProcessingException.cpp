	...
	namespace Reasoner {
		...
		namespace Kernel {
			...
			namespace Algorithm {
				...
				CCalculationStopProcessingException::CCalculationStopProcessingException(bool taskCompleted) {
				...
				bool CCalculationStopProcessingException::isTaskCompletedProcessed() const {
