...
#ifndef KONCLUDE_REASONER_KERNEL_TASK_CSATISFIABLETASKANSWERERINSTANCEPROPAGATIONMESSAGEADAPTER_H
#define KONCLUDE_REASONER_KERNEL_TASK_CSATISFIABLETASKANSWERERINSTANCEPROPAGATIONMESSAGEADAPTER_H
	...
	namespace Reasoner {
		...
		namespace Kernel {
			...
			namespace Task {
				 ...
				 *
				 */
				class CSatisfiableTaskAnswererInstancePropagationMessageAdapter {
					// public methods
					public:
						//! Constructor
...
#endif // KONCLUDE_REASONER_KERNEL_TASK_CSATISFIABLETASKANSWERERINSTANCEPROPAGATIONMESSAGEADAPTER_H
