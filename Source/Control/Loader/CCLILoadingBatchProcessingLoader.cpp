...
namespace Konclude {
	...
	namespace Control {
		...
		namespace Loader {
			...
			CCLILoadingBatchProcessingLoader::CCLILoadingBatchProcessingLoader() {
			}
			...
			void CCLILoadingBatchProcessingLoader::createTestingCommands() {
				createLoadingTesingCommands();
			}


			void CCLILoadingBatchProcessingLoader::createLoadingTesingCommands() {
				logOutputMessage(QString("Starting loading of ontology '%1'.").arg(mRequestFileString));
