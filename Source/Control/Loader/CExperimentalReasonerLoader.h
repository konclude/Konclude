...
#ifndef KONCLUDE_Control_LOADER_CEXPERIMENTALREASONERLOADER_H
#define KONCLUDE_Control_LOADER_CEXPERIMENTALREASONERLOADER_H
...
namespace Konclude {
	...
	namespace Control {
		...
		namespace Loader {
			...
			/*! 
			 *
			 *		\class		CExperimentalReasonerLoader
			 *		\author		Andreas Steigmiller
			 *		\version	0.1
			 *		\brief		TODO
			 *
			 */
			class CExperimentalReasonerLoader : public CDefaultReasonerLoader {
				// public methods
				public:
					//! Constructor
					CExperimentalReasonerLoader();

					//! Destructor
					virtual ~CExperimentalReasonerLoader();
...
#endif // KONCLUDE_Control_LOADER_CEXPERIMENTALREASONERLOADER_H
