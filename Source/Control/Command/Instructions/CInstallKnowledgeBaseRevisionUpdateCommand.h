			...
			namespace Instructions {
				...
				class CInstallKnowledgeBaseRevisionUpdateCommand : public CKnowledgeBaseCommand {
					...
					public:
						...
						CInstallKnowledgeBaseRevisionUpdateCommand(const QString &knowledgeBaseNameString, COntologyRevision* ontRevision, CCommand *parentSuperCommand = 0);
					...
					protected:
						...
						COntologyRevision* mOntRevision;
