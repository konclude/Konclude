...
#ifndef KONCLUDE_CONTROL_COMMAND_CSAXPARSEOWL2XMLONTOLOGYCOMMAND_H
	...
	namespace Control {
		...
		namespace Command {
			...
			namespace Instructions {
				...
				/*! 
				 *
				 *		\class		CSAXParseOWL2XMLOntologyCommand
				 *		\author		Andreas Steigmiller
				 *		\version	0.1
				 *		\brief		TODO
				 *
				 */
				class CSAXParseOWL2XMLOntologyCommand : public CParseOntologyCommand, public CKnowledgeBaseRevisionCommandProvider {
					// public methods
					public:
						//! Constructor
						CSAXParseOWL2XMLOntologyCommand(const QString& sourceStringName, CKnowledgeBaseRevisionCommandProvider *ontologyRevisionProviderCommand, CCommand *parentSuperCommand = 0);

						//! Destructor
						virtual ~CSAXParseOWL2XMLOntologyCommand();
...
#endif // KONCLUDE_CONTROL_COMMAND_CSAXPARSEOWL2XMLONTOLOGYCOMMAND_H
