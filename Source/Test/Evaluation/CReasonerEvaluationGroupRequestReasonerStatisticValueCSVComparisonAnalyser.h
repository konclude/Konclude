...
#ifndef KONCLUDE_TEST_EVALUATION_CREASONEREVALUATIONGROUPREQUESTREASONERSTATISTICVALUECSVCOMPARISONANALYSER_H
#define KONCLUDE_TEST_EVALUATION_CREASONEREVALUATIONGROUPREQUESTREASONERSTATISTICVALUECSVCOMPARISONANALYSER_H
...
namespace Konclude {
	...
	namespace Test {
		...
		namespace Evaluation {
			...
			/*! 
			 *
			 *		\class		CReasonerEvaluationGroupRequestReasonerStatisticValueCSVComparisonAnalyser
			 *		\author		Andreas Steigmiller
			 *		\version	0.1
			 *		\brief		TODO
			 *
			 */
			class CReasonerEvaluationGroupRequestReasonerStatisticValueCSVComparisonAnalyser : public CReasonerEvaluationGroupRequestReasonerComparisonAnalyser {
				// public methods
				public:
					//! Constructor
					...
					//! Destructor
					virtual ~CReasonerEvaluationGroupRequestReasonerStatisticValueCSVComparisonAnalyser();
...
#endif // KONCLUDE_TEST_EVALUATION_CREASONEREVALUATIONGROUPREQUESTREASONERSTATISTICVALUECSVCOMPARISONANALYSER_H
