...
#ifndef KONCLUDE_TEST_EVALUATION_CREASONEREVALUATIONGROUPREQUESTREASONERACCUMULATEDCOUNTCSVCOMPARISONANALYSER_H
...
namespace Konclude {
	...
	namespace Test {
		...
		namespace Evaluation {
			...
			/*! 
			 *
			 *		\class		CReasonerEvaluationGroupRequestReasonerAccumulatedCountCSVComparisonAnalyser
			 *		\author		Andreas Steigmiller
			 *		\version	0.1
			 *		\brief		TODO
			 *
			 */
			class CReasonerEvaluationGroupRequestReasonerAccumulatedCountCSVComparisonAnalyser : public CReasonerEvaluationGroupRequestReasonerComparisonAnalyser {
				// public methods
				public:
					//! Constructor
					...
					//! Destructor
					virtual ~CReasonerEvaluationGroupRequestReasonerAccumulatedCountCSVComparisonAnalyser();
...
#endif // KONCLUDE_TEST_EVALUATION_CREASONEREVALUATIONGROUPREQUESTREASONERACCUMULATEDCOUNTCSVCOMPARISONANALYSER_H
