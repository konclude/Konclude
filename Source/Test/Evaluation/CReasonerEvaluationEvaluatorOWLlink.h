...
#ifndef KONCLUDE_TEST_EVALUATION_CREASONEREVALUATIONEVALUATOROWLLINK_H
#define KONCLUDE_TEST_EVALUATION_CREASONEREVALUATIONEVALUATOROWLLINK_H
...
namespace Konclude {
	...
	namespace Test {
		...
		namespace Evaluation {
			...
			/*! 
			 *
			 *		\class		CReasonerEvaluationEvaluatorOWLlink
			 *		\author		Andreas Steigmiller
			 *		\version	0.1
			 *		\brief		TODO
			 *
			 */
			class CReasonerEvaluationEvaluatorOWLlink : public CReasonerEvaluationEvaluator {
				// public methods
				public:
					//! Constructor
					CReasonerEvaluationEvaluatorOWLlink();

					//! Destructor
					virtual ~CReasonerEvaluationEvaluatorOWLlink();
...
#endif // KONCLUDE_TEST_EVALUATION_CREASONEREVALUATIONEVALUATOROWLLINK_H
