...
#ifndef KONCLUDE_TEST_ANALYSE_READER_CTASKRESERVEQUEUEUPDATEREADER_H
#define KONCLUDE_TEST_ANALYSE_READER_CTASKRESERVEQUEUEUPDATEREADER_H
...
#include "Scheduler/CTaskReserveQueue.h"
	...
	namespace Test {
		...
		namespace Analyse {
			...
			namespace Reader {
				...
				/*! 
				 *
				 *		\class		CTaskReserveQueueUpdateReader
				 *		\author		Andreas Steigmiller
				 *		\version	0.1
				 *		\brief		TODO
				 *
				 */
				class CTaskReserveQueueUpdateReader : public CAnalyseValueUpdateReader {
					// public methods
					public:
						//! Constructor
						...
						//! Destructor
						virtual ~CTaskReserveQueueUpdateReader();
...
#endif // KONCLUDE_TEST_ANALYSE_READER_CTASKRESERVEQUEUEUPDATEREADER_H
