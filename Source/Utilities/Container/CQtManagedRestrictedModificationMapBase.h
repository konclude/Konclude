...
#ifndef KONCLUDE_UTILITIES_CONTAINER_CQTMANAGEDRESTRICTEDMODIFICATIONMAPBASE_H
...
namespace Konclude {
	...
	namespace Utilities {
		...
		namespace Container {
			...
			/*! 
			 *
			 *		\class		CQtManagedRestrictedModificationMapBase
...
#endif // KONCLUDE_UTILITIES_CONTAINER_CQTMANAGEDRESTRICTEDMODIFICATIONMAPBASE_H
