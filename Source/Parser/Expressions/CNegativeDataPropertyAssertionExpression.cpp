...
namespace Konclude {
	...
	namespace Parser {
		...
		namespace Expression {
			...
			CNegativeDataPropertyAssertionExpression::CNegativeDataPropertyAssertionExpression(CDataPropertyTermExpression *propertyExpression1, CIndividualTermExpression *sourceExpression2, CDataLiteralTermExpression *targetExpression3) 
