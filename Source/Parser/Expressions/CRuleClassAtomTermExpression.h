...
namespace Konclude {
	...
	namespace Parser {
		...
		namespace Expression {
			 ...
			 *
			 */
			class CRuleClassAtomTermExpression : public CRuleAtomTermExpression, public CClassTermExpressionAssociator, public CObjectIndividualVariableTermExpressionAssociator {
				// public methods
				public:
					//! Constructor
