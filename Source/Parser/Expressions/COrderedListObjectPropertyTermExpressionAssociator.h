...
namespace Konclude {
	...
	namespace Parser {
		...
		namespace Expression {
			 ...
			 *
			 */
			class COrderedListObjectPropertyTermExpressionAssociator : public CListExpressionAssociator {
				// public methods
				public:
					//! Constructor
					...
					virtual bool compareStructuralEquivalence(const COrderedListObjectPropertyTermExpressionAssociator& orderedListExpressionAssociator);
