...
#ifndef KONCLUDE_PARSER_EXPRESSION_COBJECTPROPERTYASSERTIONEXPRESSION_H
#define KONCLUDE_PARSER_EXPRESSION_COBJECTPROPERTYASSERTIONEXPRESSION_H
...
namespace Konclude {
	...
	namespace Parser {
		...
		namespace Expression {
			...
			/*! 
			 *
			 *		\class		CObjectPropertyAssertionExpression
			 *		\author		Andreas Steigmiller
			 *		\version	0.1
			 *		\brief		TODO
			 *
			 */
			class CObjectPropertyAssertionExpression : public CAssertionAxiomExpression, public COrderedPairIndividualTermExpressionAssociator, public CObjectPropertyTermExpressionAssociator {
				// public methods
				public:
					//! Constructor
					...
					//! Destructor
					virtual ~CObjectPropertyAssertionExpression();
...
#endif // KONCLUDE_PARSER_EXPRESSION_COBJECTPROPERTYASSERTIONEXPRESSION_H
