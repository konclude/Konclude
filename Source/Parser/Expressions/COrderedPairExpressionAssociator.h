...
#ifndef KONCLUDE_PARSER_EXPRESSION_CORDEREDPAIREXPRESSIONASSOCIATOR_H
#define KONCLUDE_PARSER_EXPRESSION_CORDEREDPAIREXPRESSIONASSOCIATOR_H
...
namespace Konclude {
	...
	namespace Parser {
		...
		namespace Expression {
			...
			/*! 
			 *
			 *		\class		COrderedPairExpressionAssociator
			 *		\author		Andreas Steigmiller
			 *		\version	0.1
			 *		\brief		TODO
			 *
			 */
			class COrderedPairExpressionAssociator : public CPairExpressionAssociator {
				// public methods
				public:
					//! Constructor
...
#endif // KONCLUDE_PARSER_EXPRESSION_CORDEREDPAIREXPRESSIONASSOCIATOR_H
