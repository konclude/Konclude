...
#ifndef KONCLUDE_PARSER_EXPRESSION_COBJECTHASVALUEEXPRESSION_H
#define KONCLUDE_PARSER_EXPRESSION_COBJECTHASVALUEEXPRESSION_H
...
namespace Konclude {
	...
	namespace Parser {
		...
		namespace Expression {
			...
			/*! 
			 *	\class		CObjectHasValueExpression
			 *	\author		Andreas Steigmiller
			 *	\version	0.1
			 *	\brief		TODO
			 */
			class CObjectHasValueExpression : public CClassTermExpression, public CObjectPropertyTermExpressionAssociator, public CIndividualTermExpressionAssociator {
				// public methods
				public:
					//! Constructor
					...
					//! Destructor
					virtual ~CObjectHasValueExpression();
...
#endif // KONCLUDE_PARSER_EXPRESSION_COBJECTHASVALUEEXPRESSION_H
